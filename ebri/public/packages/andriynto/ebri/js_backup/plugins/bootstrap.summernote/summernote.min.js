!function (a) {
        ...
        var d = new k, e = new l, g = new m, i = new n, j = new o, p = {BACKSPACE: 8, TAB: 9, ENTER: 13, SPACE: 32, NUM0: 48, NUM1: 49, NUM6: 54, NUM7: 55, NUM8: 56, B: 66, E: 69, I: 73, J: 74, K: 75, L: 76, R: 82, S: 83, U: 85, Y: 89, Z: 90, SLASH: 191, LEFTBRACKET: 219, BACKSLACH: 220, RIGHTBRACKET: 221}, q = function (b) {
            ...
            if (h.length > 0) {
                ...
                if (d[k] && (r.trigger("focus"), d[k](r, l, i)), -1 !== a.inArray(k, ["backColor", "foreColor"]))
                    ...
                    r.focus(), j.showImageDialog(p, t, function (a) {
                        s(r, a)
                    }, function (a) {
                    ...
                    if (z)
                        r.data("orgHeight", r.css("height")), a(window).resize(y).trigger("resize");
                    else {
                    ...
                    if (B) {
                        ...
                        c.bCodeMirror && u.data("cmEditor").toTextArea(), r.html(u.val() || f.emptyPara), r.height(r.data("optionHeight") ? u.height() : "auto"), e.enable(o), r.focus();
    ...
    a.fn.extend({summernote: function (b) {
            if (b = a.extend({toolbar: [["style", ["style"]], ["font", ["bold", "italic", "underline", "clear"]], ["fontsize", ["fontsize"]], ["color", ["color"]], ["para", ["ul", "ol", "paragraph"]], ["height", ["height"]], ["table", ["table"]], ["insert", ["link", "picture", "video"]], ["view", ["fullscreen", "codeview"]], ["help", ["help"]]], locale: "en-US"}, b), this.each(function (c, d) {
                var e = a(d);
                s.createLayout(e, b);
