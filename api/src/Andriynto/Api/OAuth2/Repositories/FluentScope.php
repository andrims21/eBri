...
class FluentScope implements ScopeInterface
{
    ...
    public function getScope($scope, $clientId = null, $grantType = null)
    {
        ...
        if (Config::get('Andriynto/api::oauth2.limit_clients_to_scopes') === true and ! is_null($clientId)) {
        ...
        if (Config::get('Andriynto/api::oauth2.limit_scopes_to_grants') === true and ! is_null($grantType)) {
